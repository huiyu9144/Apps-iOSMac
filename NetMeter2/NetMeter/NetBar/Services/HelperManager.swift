...
class HelperManager {
    ...
    private let outputPath = "/tmp/com.yuhui.netbar.traffic.json"
    private let triggerPath = "/tmp/com.yuhui.netbar.trigger"
    private let daemonPlist = "com.yuhui.netbar.helper"
